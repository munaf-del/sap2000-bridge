"""Manual bridge call: read SAP2000 frame metadata."""
...
def main() -> None:
    ...
    print("Manual frame metadata smoke. No save, no modification, no analysis.")
    with request.urlopen(f"{BRIDGE_URL}/sap2000/model/frames", timeout=60) as response:

"""Manual bridge call: read SAP2000 load combination metadata."""
...
def main() -> None:
    ...
    print("Manual load-combination metadata smoke. No save, no modification, no analysis.")
    with request.urlopen(f"{BRIDGE_URL}/sap2000/model/load-combinations", timeout=60) as response:

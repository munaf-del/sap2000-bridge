"""Manual bridge call: read SAP2000 load case metadata."""
...
def main() -> None:
    ...
    print("Manual load-case metadata smoke. No save, no modification, no analysis.")
    with request.urlopen(f"{BRIDGE_URL}/sap2000/model/load-cases", timeout=60) as response:

"""Manual bridge call: read SAP2000 material metadata."""
...
def main() -> None:
    ...
    print("Manual material metadata smoke. No save, no modification, no analysis.")
    with request.urlopen(f"{BRIDGE_URL}/sap2000/model/materials", timeout=60) as response:

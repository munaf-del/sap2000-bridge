"""Manual bridge call: read SAP2000 frame section metadata."""
...
def main() -> None:
    ...
    print("Manual section metadata smoke. No save, no modification, no analysis.")
    with request.urlopen(f"{BRIDGE_URL}/sap2000/model/sections", timeout=60) as response:
